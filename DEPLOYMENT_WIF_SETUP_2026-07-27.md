...
| WIF_PROVIDER | projects/356950571433/locations/global/workloadIdpools/github-pool/providers/github | ✅ 설정됨 |
...
WIF를 통한 토큰 교환
    ↓
Google Cloud 서비스 계정 (github-deploy)
    ↓
Cloud Run 배포 (hotel-roomcheck)
```
...
**해결**: gcloud CLI를 사용한 자동 생성 ✅ (완료)

### 문제 3: Artifact Registry API 미활성화
**원인**: Docker 이미지 푸시 시 API가 활성화되지 않음
**해결**: Google Cloud Console에서 수동 활성화 ✅ (완료)
